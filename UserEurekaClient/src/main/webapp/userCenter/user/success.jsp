...
$(function() {
	...
	$.getJSON("http://localhost:8762/service-user/getOrderDetail.action",{goodsdetail_id:id},function(data) {
		if(data.code==1) {
			...
			$("#receive").html(str);
			var order = data.obj;
			var s = "<div class='con-parent clearfix fl'><a href='javascript:;' class='fl position-parent'> <img src='http://localhost:8762/service-admin/imgGoods/"+order.images[0].image_path+"'>";
