	...
	<script>
	 $('#user-btn').on('click',function(){
		 if(check()!=false) {
			 ...
			 $.getJSON("http://localhost:8762/service-user/updatepwd.action",{'user_pwd':password},function(data) {
				 if(data.code==1) {
					 window.location.href="http://localhost:8762/service-user/userCenter/forget4.jsp";
				 } else {
					 alert("修改失败！")
				 }
			 })
