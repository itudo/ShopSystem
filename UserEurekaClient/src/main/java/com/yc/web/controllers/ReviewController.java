...
public class ReviewController {
	...
	public JsonModel addReview(HttpSession session,OrderDetail orderDetail,@RequestParam("file") MultipartFile file, @RequestParam(name = "level") String review_level,@RequestParam(name="context") String review_content,HttpServletRequest request) {
        ...
        try {
			...
			review.setReview_level(Integer.parseInt(review_level));
